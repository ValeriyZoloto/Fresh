!(function (t, e) {
	...
	var f = (function (n) {
		...
		try {
			M.apply((e = j.call(v.childNodes)), v.childNodes),
				...
				if (11 !== d && (a = et.exec(e)))
					if ((c = a[1])) {
						...
						if (
							...
							return M.apply(n, t.getElementsByClassName(c)), n;
					}
				if (
					p.qsa &&
					!I[e + " "] &&
					...
					if (
						((c = e), (u = t), 1 === d && (X.test(e) || G.test(e)))
					) {
						for (
							((u = (nt.test(e) && gt(t.parentNode)) || t) ===
								t &&
								p.scope) ||
								((s = t.getAttribute("id"))
									? (s = s.replace(ot, rt))
				...
				return (
					t != S &&
						...
						(p.getById = ut(function (t) {
							return (
								(s.appendChild(t).id = A),
								!S.getElementsByName ||
									!S.getElementsByName(A).length
							);
						})),
						p.getById
						...
						(a = []),
						(m = []),
						(p.qsa = tt.test(S.querySelectorAll)) &&
							(ut(function (t) {
								var e;
		...
		(at.contains = function (t, e) {
			return (t.ownerDocument || t) != S && C(t), y(t, e);
		}),
		(at.attr = function (t, e) {
			(t.ownerDocument || t) != S && C(t);
			var n = w.attrHandle[e.toLowerCase()],
				n =
					n && P.call(w.attrHandle, e.toLowerCase())
						? n(t, e, !T)
						: void 0;
			return void 0 !== n
				? n
			...
			return (
				...
				ct(function (t, e, n, i) {
					var o,
						...
						d = !f || (!t && h) ? u : wt(u, a, f, n, i),
						p = g ? (y || (t ? f : c || m) ? [] : e) : d;
					if ((g && g(d, p, n, i), m))
						for (o = wt(p, l), m(o, [], n, i), r = o.length; r--; )
							(s = o[r]) && (p[l[r]] = !(d[l[r]] = s));
					if (t) {
						if (y || f) {
							if (y) {
					...
					} else (p = wt(p === e ? p.splice(c, p.length) : p)), y ? y(null, e, p, i) : M.apply(e, p);
				})
			);
		}
		function Ct(m, y) {
		...
		return (
					...
					if (((n = n || []), 1 === u.length)) {
						...
						for (
							...
							if (
								...
								(i = l(
									s.matches[0].replace(it, d),
									(nt.test(r[0].type) && gt(e.parentNode)) ||
										e
								))
							) {
			...
			(p.sortStable = A.split("").sort(N).join("") === A),
	...
	(T.fn.init = function (t, e, n) {
		...
		return (
			(t = S.getElementById(i[2])) && ((this[0] = t), (this.length = 1)),
			this
		);
	}).prototype = T.fn;
	var N = T(S),
				...
				T.fn[i] = function (t, e) {
					...
					return (
						(e = "Until" !== i.slice(-5) ? t : e) &&
							...
							(n = T.filter(e, n)),
						1 < this.length &&
							(R[i] || T.uniqueSort(n), P.test(i) && n.reverse()),
						this.pushStack(n)
					);
				};
			}
	...
	(T.Callbacks = function (i) {
		...
		T.extend({
					...
					s = {
						...
						then: function (e, n, i) {
							...
							return T.Deferred(function (t) {
								r[0][3].add(
									c(0, t, b(i) ? i : j, t.notifyWith)
								),
									r[1][3].add(c(0, t, b(e) ? e : j)),
									r[2][3].add(c(0, t, b(n) ? n : L));
							}).promise();
						},
						promise: function (t) {
			...
			when: function (t) {
				...
				if (
					n <= 1 &&
					(B(t, s.done(e(i)).resolve, s.reject, !n),
	...
	function G(t) {
		return t.replace(_, "ms-").replace(z, U);
	}
	function X(t) {
	...
	var lt = {};
	function ct(t, e) {
		for (var n, i, o, r, s, a = [], l = 0, c = t.length; l < c; l++)
			(i = t[l]).style &&
				((n = i.style.display),
				e
					? ("none" === n &&
	...
	function ht(t, e) {
		var n =
			void 0 !== t.getElementsByTagName
				...
				: [];
		return void 0 === e || (e && D(t, e)) ? T.merge([t], n) : n;
	}
	function gt(t, e) {
		for (var n = 0, i = t.length; n < i; n++)
	...
	function St(t, o, r) {
		r
			...
			: void 0 === V.get(t, o) && T.event.add(t, o, bt);
	}
	(T.event = {
		global: {},
		...
		dispatch: function (t) {
			...
			for (s[0] = a, e = 1; e < arguments.length; e++)
				s[e] = arguments[e];
			if (
	...
	function Nt(n, i, o, r) {
		...
		var t,
			...
			f = i[0],
			h = b(f);
		if (h || (1 < d && "string" == typeof f && !v.checkClone && At.test(f)))
			return n.each(function (t) {
				var e = n.eq(t);
				h && (i[0] = f.call(this, t, e.html())), Nt(e, i, o, r);
			});
		if (
			d &&
			...
			for (a = (s = T.map(ht(t, "script"), Et)).length; u < d; u++)
				(l = t),
					u !== p &&
						((l = T.clone(l, !0, !0)),
						a && T.merge(s, ht(l, "script"))),
					o.call(n[u], l, u);
			if (a)
				for (
					c = s[s.length - 1].ownerDocument, T.map(s, Ot), u = 0;
					u < a;
					u++
				)
					(l = s[u]),
						pt.test(l.type || "") &&
							...
							(l.src && "module" !== (l.type || "").toLowerCase()
								...
								: w(l.textContent.replace(kt, ""), l, c));
		}
		return n;
	}
	function Pt(t, e, n) {
	...
	T.extend({
		...
		clone: function (t, e, n) {
			...
			if (e)
				if (n)
					for (
						r = r || ht(t), s = s || ht(u), i = 0, o = r.length;
						i < o;
						i++
					)
						It(r[i], s[i]);
	...
	function Ut() {
		...
		qt &&
			...
			it.appendChild(Ht).appendChild(qt),
	...
	(Ht = S.createElement("div")),
		(qt = S.createElement("div")).style &&
			...
			(v.clearCloneStyle = "content-box" === qt.style.backgroundClip),
			T.extend(v, {
	...
	function de() {
		le &&
			(!1 === S.hidden && C.requestAnimationFrame
				? C.requestAnimationFrame(de)
				: C.setTimeout(de, T.fx.interval),
			T.fx.tick());
	}
	function pe() {
		return (
	...
	function ge(o, t, e) {
		var n,
			...
			l = function () {
				...
				for (
					...
					c.tweens[n].run(e);
				return (
					a.notifyWith(o, [c, e, t]),
					e < 1 && i
						? t
						: (i || a.notifyWith(o, [c, 1, 0]),
						  a.resolveWith(o, [c]),
						  !1)
				);
			},
		...
		for (
			...
			if ((n = ge.prefilters[i].call(c, o, u, c.opts)))
				return (
					b(n.stop) &&
			...
			return arguments.length
				? ((i = b(e)),
				  this.each(function (t) {
						1 === this.nodeType &&
							(null ==
							(t = i ? e.call(this, t, T(this).val()) : e)
								? (t = "")
								: "number" == typeof t
								? (t += "")
								: Array.isArray(t) &&
				...
				select: {
					...
					set: function (t, e) {
						for (
							...
							((i = o[s]).selected =
								-1 < T.inArray(T.valHooks.option.get(i), r)) &&
								(n = !0);
	...
	T.extend(T.event, {
		trigger: function (t, e, n, i) {
			...
			if (
				...
				for (o = 0; (h = d[o++]) && !t.isPropagationStopped(); )
					(u = h),
					...
					i ||
						...
						(a &&
							...
							t.isPropagationStopped() &&
								u.addEventListener(p, Te),
							n[p](),
							t.isPropagationStopped() &&
								u.removeEventListener(p, Te),
			...
			ajax: function (t, e) {
				...
				var l,
					...
					w = {
						...
						overrideMimeType: function (t) {
							return null == p && (h.mimeType = t), this;
						},
				...
				function x(t, e, n, i) {
					...
					p ||
						...
						(w.statusText = (e || a) + ""),
						i
							? y.resolveWith(g, [o, a, w])
							: y.rejectWith(g, [w, a, r]),
						w.statusCode(b),
						(b = void 0),
						f &&
	...
	T.ajaxSetup({
		...
		jsonpCallback: function () {
			var t = Ye.pop() || T.expando + "_" + De.guid++;
			return (this[t] = !0), t;
		},
	}),
		...
		(T.offset = {
			setOffset: function (t, e, n) {
				...
				"static" === a && (t.style.position = "relative"),
					...
					null !=
						(e = b(e) ? e.call(t, n, T.extend({}, r)) : e).top &&
						(c.top = e.top - r.top + o),
		...
		T.each(["top", "left"], function (t, n) {
			T.cssHooks[n] = Yt(v.pixelPosition, function (t, e) {
				if (e)
					return (
						(e = Xt(t, n)),
						Wt.test(e) ? T(t).position()[n] + "px" : e
					);
			});
		}),
					...
					for (
						...
						for (
							...
							for (
								...
								var u =
									t * n + (a * i.options.slidesPerRow + c);
			...
			(s.prototype.changeSlide = function (t, e) {
				...
				switch (
					...
					case "previous":
						(r =
							...
							i.slideCount > i.options.slidesToShow &&
								i.slideHandler(i.currentSlide - r, !1, e);
						break;
					case "next":
					...
					case "index":
						...
						i.slideHandler(i.checkNavigable(r), !1, e),
								...
								!0 === r.options.infinite
									...
									: ((e = Math.max(
									  ...
									  r.options.slidesToShow / 2 +
											...
											2 +
											r.currentSlide))
						: ((e = r.options.infinite
								? r.options.slidesToShow + r.currentSlide
								: r.currentSlide),
						  (n = Math.ceil(e + r.options.slidesToShow)),
						  !0 === r.options.fade &&
								(0 < e && e--, n <= r.slideCount && n++)),
					(t = r.$slider.find(".slick-slide").slice(e, n)),
					...
					if (
						...
						for (e in i)
							if ("array" !== c.type(r.options.responsive))
								...
								for (
									t = r.options.responsive.length - 1;
									0 <= t;
			...
			(s.prototype.slideHandler = function (t, e, n) {
				...
				if (
					...
					if (
						...
						(a.currentLeft =
							null === a.swipeLeft ? e : a.swipeLeft),
						!1 === a.options.infinite &&
							!1 === a.options.centerMode &&
							(t < 0 ||
								t > a.getDotCount() * a.options.slidesToScroll))
					)
						!1 === a.options.fade &&
							((i = a.currentSlide),
				...
				for (
					...
					if (
						("object" == typeof n || void 0 === n
							? (e[r].slick = new s(e[r], n))
							: (t = e[r].slick[n].apply(e[r].slick, i)),
						void 0 !== t)
					)
						return t;
				return e;
		...
		!(function () {
			for (
				var o,
					...
					n = -1,
					n = 0;
				n < t.length && !p.requestAnimationFrame;
				n++
			)
				p.requestAnimationFrame = p[t[n] + "RequestAnimationFrame"];
			function i() {}
			void 0 === e.nextElementSibling &&
				...
				Array.prototype.indexOf ||
					(Array.prototype.indexOf = function (t) {
						...
						if (
							...
							return -1;
						for (
							n = 0 <= e ? e : Math.max(o - Math.abs(e), 0);
							n < o;
							n++
						)
				...
				p.Element.prototype.dispatchEvent ||
					(p.Element.prototype.dispatchEvent = function (t) {
						try {
			...
			((f = function (t, e, n) {
				...
				if (
					...
					u = a.querySelectorAll(t);
				else if (t && "object" == typeof t && h.isElement(t, a))
					u = [t];
				else {
					if (!t || "object" != typeof t || !t.length)
						throw new Error(
							f.messages.errorFactoryInvalidContainer()
						);
					u = t;
				}
				if (u.length < 1)
					throw new Error(f.messages.errorFactoryContainerNotFound());
				for (d = 0; (o = u[d]) && (!(0 < d) || r); d++)
					o.id
						? (c = o.id)
						: ((c = "MixItUp" + h.randomHex()), (o.id = c)),
						f.instances[c] instanceof f.Mixer
							? ((s = f.instances[c]),
							  (!e ||
									(e &&
										e.debug &&
										!1 !== e.debug.showWarnings)) &&
									console.warn(
										f.messages.warningFactoryPreexistingInstance()
									))
							: ((s = new f.Mixer()).attach(o, a, c, e),
							  (f.instances[c] = s)),
						(i = new f.Facade(s)),
						e && e.debug && e.debug.enable ? l.push(s) : l.push(i);
				return r ? new f.Collection(l) : l[0];
			}).use = function (t) {
			...
			(h = {
				...
				handleExtendError: function (t, e) {
					...
					if (
						...
						for (a in ((o = i[1]), e)) {
							for (
								c = 0;
								c < o.length && o.charAt(c) === a.charAt(c);
						...
						throw (
							(1 < l &&
								(r =
									f.messages.errorConfigInvalidPropertySuggestion(
										{ probableMatch: s }
									)),
							(n = f.messages.errorConfigInvalidProperty({
								erroneous: o,
								suggestion: r,
							})),
							new TypeError(n))
				...
				template: function (i) {
					for (var t, e = /\${([\w]*)}/g, o = {}; (t = e.exec(i)); )
						o[t[1]] = new RegExp("\\${" + t[1] + "}", "g");
					return function (t) {
						var e = "",
							n = i;
						for (e in ((t = t || {}), o))
							n = n.replace(o[e], void 0 !== t[e] ? t[e] : "");
						return n;
					};
				},
				on: function (t, e, n, i) {
				...
				getCustomEvent: function (t, e, n) {
					...
					return (
						(n = n || p.document),
						"function" == typeof p.CustomEvent
							? (i = new p.CustomEvent(t, {
									detail: e,
									bubbles: !0,
									cancelable: !0,
							  }))
							...
							? (i =
									n.createEvent(
										"CustomEvent"
									)).initCustomEvent(t, !0, !0, e)
							: (((i = n.createEventObject()).type = t),
							  (i.returnValue = !1),
							  (i.cancelBubble = !1),
							  (i.detail = e)),
						i
				...
				isElement: function (t, e) {
					return (
						(e = e || p.document),
						!!(p.HTMLElement && t instanceof p.HTMLElement) ||
							!!(
								e.defaultView &&
				...
				createElement: function (t, e) {
					var n = null,
						i = null,
						n = (e = e || p.document).createDocumentFragment();
					for (
						(i = e.createElement("div")).innerHTML = t.trim();
						i.firstChild;
				...
				arrayShuffle: function (t) {
					for (var e, n, i = t.slice(), o = i.length, r = o; r--; )
						(e = ~~(Math.random() * o)),
							(n = i[r]),
							(i[r] = i[e]),
							(i[e] = n);
				...
				arrayFromList: function (e) {
					...
					try {
						...
						for (n = [], i = 0; i < e.length; i++) n.push(e[i]);
						return n;
					}
				},
				...
				closestParent: function (t, e, n, i) {
					var o = t.parentNode;
					if (((i = i || p.document), n && t.matches(e))) return t;
					for (; o && o != i.body; ) {
				...
				defer: function (t) {
					...
					return (
						f.features.has.promises
							...
							: p.console &&
							  console.warn(
									f.messages.warningNoPromiseImplementation()
							  ),
						n
					);
				},
				all: function (t, e) {
					...
					return f.features.has.promises
						? Promise.all(t)
						: (n = p.jQuery || e.$) && "function" == typeof n.when
				...
				getDocumentState: function (t) {
					return (
						(t = "object" == typeof t.body ? t : p.document),
						{
				...
				isVisible: function (t) {
					...
					return (
						!!t.offsetParent ||
						("fixed" === (e = p.getComputedStyle(t)).position &&
							"hidden" !== e.visibility &&
							"0" !== e.opacity)
					);
				},
				...
				compareVersions: function (t, e) {
					for (
						...
						if (
							((n = parseInt(o[s].replace(/[^\d.]/g, ""))),
							(i = parseInt(r[s].replace(/[^\d.]/g, "") || 0)) <
								n)
						)
							return !1;
						if (n < i) return !0;
				...
				getClassname: function (t, e, n) {
					...
					return (
						...
						n
							? (i.length && (i += t.delineatorModifier),
							  (i += n))
							: i
					);
				},
			...
			(f.Base.prototype = {
				...
				callFilters: function (t, e, n) {
					var i = this.constructor.filters[t],
						o = e,
						r = "";
					if (!i || h.isEmptyObject(i)) return o;
					for (r in ((n = n || []), i))
						(n = h.arrayFromList(n)).unshift(o),
							(o = i[r].apply(this, n));
					return o;
				},
			}),
			...
			h.extend(f.Features.prototype, {
				...
				runTests: function () {
					...
					t.callActions("beforeRunTests", arguments),
						...
						(t.has.transitions =
							"unsupported" !== t.transitionPrefix),
				...
				setPrefixes: function () {
					...
					t.callActions("beforeSetPrefixes", arguments),
						...
						(t.transformPrefix = h.getPrefix(
							t.canary,
							"Transform",
							t.VENDORS
						)),
						(t.boxSizingPrefix = h.getPrefix(
							t.canary,
							"BoxSizing",
							t.VENDORS
						)),
						(t.boxSizingProp = t.boxSizingPrefix
							? t.boxSizingPrefix +
							  h.pascalCase(t.BOX_SIZING_PROP)
							: t.BOX_SIZING_PROP),
						(t.transitionProp = t.transitionPrefix
							? t.transitionPrefix +
							  h.pascalCase(t.TRANSITION_PROP)
							: t.TRANSITION_PROP),
						...
						(t.perspectiveProp = t.transformPrefix
							? t.transformPrefix +
							  h.pascalCase(t.PERSPECTIVE_PROP)
							: t.PERSPECTIVE_PROP),
						(t.perspectiveOriginProp = t.transformPrefix
							? t.transformPrefix +
							  h.pascalCase(t.PERSPECTIVE_ORIGIN_PROP)
			...
			(f.CommandChangeLayout.prototype.constructor =
				f.CommandChangeLayout),
			(f.ControlDefinition = function (t, e, n, i) {
				f.Base.call(this),
					this.callActions("beforeConstruct"),
					(this.type = t),
					(this.selector = e),
			...
			f.controlDefinitions.push(
				new f.ControlDefinition("sort", "[data-sort]")
			),
			f.controlDefinitions.push(
			...
			h.extend(f.Control.prototype, {
				...
				removeBinding: function (t) {
					...
					this.callActions("beforeRemoveBinding", arguments),
						...
						e.bound.length < 1 &&
							(e.unbindClick(),
							(n = f.controls.indexOf(e)),
							f.controls.splice(n, 1),
							"active" === e.status &&
								e.renderStatus(e.el, "inactive")),
				...
				handleClick: function (t) {
					...
					if (
						...
						(i = n.selector
							? h.closestParent(
									t.target,
									o.config.selectors.control + n.selector,
									!0,
									o.dom.document
							  )
							: n.el))
						...
						switch (n.type) {
							case "filter":
								s.filter =
									n.filter || i.getAttribute("data-filter");
								break;
							case "sort":
							...
							case "multimix":
								(s.filter =
									n.filter || i.getAttribute("data-filter")),
									(s.sort =
										n.sort || i.getAttribute("data-sort"));
								break;
							case "toggle":
								(s.filter =
									n.filter || i.getAttribute("data-toggle")),
									(r =
										"live" === n.status
											? h.hasClass(i, n.classNames.active)
											: "active" === n.status);
						}
						for (l = 0; l < n.bound.length; l++)
							(e = new f.CommandMultimix()),
								h.extend(e, s),
								a.push(e);
						for (
							a = n.callFilters(
					...
					n.callActions("beforeUpdate", arguments),
						...
						0 < n.pending ||
							("live" === n.status
								...
								: ((i.sort = n.sort),
								  (i.filter = n.filter),
								  n.callFilters("actionsUpdate", i, arguments),
								  n.parseStatusChange(n.el, t, i, e)),
				...
				updateLive: function (t, e) {
					...
					if ((i.callActions("beforeUpdateLive", arguments), i.el)) {
						for (
							n = i.el.querySelectorAll(i.selector), s = 0;
							(r = n[s]);
							s++
						) {
							switch (((o = new f.CommandMultimix()), i.type)) {
								case "filter":
				...
				parseStatusChange: function (t, e, n, i) {
					var o = this,
						...
						s = -1;
					switch (
						(o.callActions("beforeParseStatusChange", arguments),
						o.type)
					) {
						case "filter":
							e.filter === n.filter
				...
				renderStatus: function (t, e) {
					var n = this;
					switch (
						(n.callActions("beforeRenderStatus", arguments), e)
					) {
						case "active":
							h.addClass(t, n.classNames.active),
								h.removeClass(t, n.classNames.disabled),
								n.canDisable && (n.el.disabled = !1);
							break;
						case "inactive":
							h.removeClass(t, n.classNames.active),
								h.removeClass(t, n.classNames.disabled),
								n.canDisable && (n.el.disabled = !1);
							break;
						case "disabled":
							n.canDisable && (n.el.disabled = !0),
								h.addClass(t, n.classNames.disabled),
								h.removeClass(t, n.classNames.active);
					}
			...
			(f.TransformDefaults.prototype = Object.create(
			...
			(f.Events.prototype.fire = function (t, e, n, i) {
				var o,
					r = new f.EventDetail();
				if (
					(this.callActions("beforeFire", arguments),
					void 0 === this[t])
				)
					throw new Error('Event type "' + t + '" not found.');
				(r.state = new f.State()),
					h.extend(r.state, n.state),
					n.futureState &&
						((r.futureState = new f.State()),
						h.extend(r.futureState, n.futureState)),
					(r.instance = n.instance),
					n.originalEvent && (r.originalEvent = n.originalEvent),
					(o = h.getCustomEvent(t, r, i)),
					this.callFilters("eventFire", o, arguments),
					e.dispatchEvent(o);
			}),
			...
			h.extend(f.Mixer.prototype, {
				...
				attach: function (t, e, n, i) {
					...
					for (
						o.callActions("beforeAttach", arguments),
							...
							f.features.has.transitions ||
								(o.config.animation.enable = !1),
							void 0 === p.console &&
								(o.config.debug.showWarnings = !1),
							o.config.data.uidKey &&
								(o.config.controls.enable = !1),
							o.indexTargets(),
							o.state = o.getInitialState(),
							s = 0;
						(r = o.lastOperation.toHide[s]);
						s++
					)
						r.hide();
				...
				getInitialState: function () {
					...
					if (
						...
						if (
							...
							throw new TypeError(
								f.messages.errorConfigDataUidKeyNotSet()
							);
						(n.startDataset =
							n.newDataset =
							e.activeDataset =
								t.config.load.dataset.slice()),
							(n.startContainerClassName =
								n.newContainerClassName =
									e.activeContainerClassName),
						...
						(e.activeFilter = t.parseFilterArgs([
							...
							"desc" === e.activeSort.order
								? ((n.newSort = e.activeSort),
								  t.sortOperation(n),
								  t.printSort(!1, n),
								  (t.targets = n.newOrder))
				...
				indexTargets: function () {
					...
					if (
						...
						(n.dom.targets = h.arrayFromList(n.dom.targets)),
						(n.targets = []),
						(e = n.config.load.dataset) &&
							e.length !== n.dom.targets.length)
					)
						throw new Error(
							f.messages.errorDatasetPrerenderedMismatch()
						);
					if (n.dom.targets.length) {
						for (o = 0; (t = n.dom.targets[o]); o++)
							(i = new f.Target()).init(t, n, e ? e[o] : void 0),
								(i.isInDom = !0),
								n.targets.push(i);
						n.dom.parent =
				...
				initControls: function () {
					...
					switch (
						...
						default:
							throw new Error(
								f.messages.errorConfigInvalidControlsScope()
							);
					}
					for (a = 0; (t = f.controlDefinitions[a]); a++)
						if (n.config.controls.live || t.live) {
							if (t.parent) {
								if (!(r = n.dom[t.parent]) || r.length < 0)
									continue;
								"number" != typeof r.length && (r = [r]);
							} else r = [o];
							for (l = 0; (i = r[l]); l++)
								(s = n.getControl(i, t.type, t.selector)),
									n.controls.push(s);
						} else
							for (
								e = o.querySelectorAll(
									n.config.selectors.control + t.selector
								),
									l = 0;
								(i = e[l]);
								l++
							)
								(s = n.getControl(i, t.type, "")) &&
									n.controls.push(s);
				...
				getControl: function (t, e, n) {
					var i = this,
						o = null,
						r = -1;
					if ((i.callActions("beforeGetControl", arguments), !n))
						for (r = 0; (o = f.controls[r]); r++) {
							if (o.el === t && o.isBound(i))
								return i.callFilters(
									"controlGetControl",
									null,
									arguments
								);
							if (o.el === t && o.type === e && o.selector === n)
								return (
									o.addBinding(i),
									i.callFilters(
										"controlGetControl",
					...
					return (
						(o = new f.Control()).init(t, e, n),
						(o.classNames.base = h.getClassname(
							i.config.classNames,
							e
						)),
						(o.classNames.active = h.getClassname(
							i.config.classNames,
							e,
							i.config.classNames.modifierActive
						)),
						(o.classNames.disabled = h.getClassname(
							i.config.classNames,
							e,
					...
					for (
						e.callActions("beforeUpdateControls", arguments),
							t.filter
								...
								: (i.filter = e.state.activeFilter.selector),
							t.sort
								? (i.sort = e.buildSortString(t.sort))
								: (i.sort = e.buildSortString(
										e.state.activeSort
								  )),
							i.filter === e.config.selectors.target &&
								(i.filter = "all"),
				...
				insertTargets: function (t, e) {
					...
					if (
						...
						(n = i.getNextSibling(t.index, t.sibling, t.position)),
						(r = i.dom.document.createDocumentFragment()),
						(o = n
							? h.index(n, i.config.selectors.target)
							: i.targets.length),
						t.collection)
					) {
						for (l = 0; (a = t.collection[l]); l++) {
							if (-1 < i.dom.targets.indexOf(a))
								throw new Error(
									f.messages.errorInsertPreexistingElement()
								);
							(a.style.display = "none"),
								...
								h.isElement(a, i.dom.document) &&
									a.matches(i.config.selectors.target) &&
									((s = new f.Target()).init(a, i),
									(s.isInDom = !0),
									i.targets.splice(o, 0, s),
									o++);
						}
						i.dom.parent.insertBefore(r, n);
					}
							...
							? (o =
									t < i.targets.length || !i.targets.length
										...
										: i.targets[i.targets.length - 1].dom.el
												.nextElementSibling)
							: 0 === i.targets.length &&
							  0 < i.dom.parent.children.length &&
				...
				sortOperation: function (n) {
					...
					if (
						...
						(n.startOrder = i.targets),
						n.newSort.collection)
					) {
						for (
							e = [], r = 0;
							(t = n.newSort.collection[r]);
							r++
						) {
							if (i.dom.targets.indexOf(t) < 0)
								throw new Error(
									f.messages.errorSortNonExistentElement()
								);
							(o = new f.Target()).init(t, i),
								(o.isInDom = !0),
								e.push(o);
						}
						n.newOrder = e;
						...
						"random" === n.newSort.order
							? (n.newOrder = h.arrayShuffle(n.startOrder))
							: "" === n.newSort.attribute
							? ((n.newOrder = i.origOrder.slice()),
							  "desc" === n.newSort.order &&
									n.newOrder.reverse())
							: ((n.newOrder = n.startOrder.slice()),
							  n.newOrder.sort(function (t, e) {
									return i.compare(t, e, n.newSort);
							  }));
					h.isEqualArray(n.newOrder, n.startOrder) &&
						(n.willSort = !1),
				...
				printSort: function (t, e) {
					var n = this,
						...
						o = t ? e.startOrder : e.newOrder,
						t = i.length
							? i[i.length - 1].dom.el.nextElementSibling
							: null,
						...
						l = -1;
					for (
						n.callActions("beforePrintSort", arguments), l = 0;
						(s = i[l]);
						l++
					)
						"absolute" !== (a = s.dom.el).style.position &&
							(h.removeWhitespace(a.previousSibling),
							a.parentElement.removeChild(a));
					for (
						(e = t ? t.previousSibling : n.dom.parent.lastChild) &&
							"#text" === e.nodeName &&
						...
						(a = s.dom.el),
							h.isElement(r.lastChild) &&
								r.appendChild(p.document.createTextNode(" ")),
							r.appendChild(a);
					n.dom.parent.firstChild &&
						...
						t
							? (r.appendChild(p.document.createTextNode(" ")),
							  n.dom.parent.insertBefore(r, t))
							: n.dom.parent.appendChild(r),
						n.callActions("afterPrintSort", arguments);
				},
				parseSortString: function (t, e) {
					for (
						var n, i = t.split(" "), o = e, r = -1, r = 0;
						r < i.length;
						r++
					) {
						switch (
				...
				parseEffects: function () {
					...
					f.transformDefaults))
						f.transformDefaults[e] instanceof f.TransformData &&
							(t.parseEffect(e, n, t.effectsIn, t.transformIn),
							t.parseEffect(
								e,
								i,
								t.effectsOut,
				...
				parseEffect: function (t, e, n, i, o) {
					var r,
						s,
						a,
						l = this,
					...
					if (e.indexOf(t) < 0)
						...
						switch (
							...
							default:
								if (
									(o &&
									l.config.animation.reverseOut &&
									"scale" !== t
										? (n[t].value =
												-1 *
												(c
													? parseFloat(c)
													: f.transformDefaults[t]
															.value))
										: (n[t].value = c
												? parseFloat(c)
								...
								} else n[t].unit = f.transformDefaults[t].unit;
				...
				buildState: function (t) {
					...
					for (
						...
						(!t.toRemove.length || t.toRemove.indexOf(i) < 0) &&
							n.targets.push(i.dom.el);
					for (o = 0; (i = t.matching[o]); o++)
						n.matching.push(i.dom.el);
					for (o = 0; (i = t.show[o]); o++) n.show.push(i.dom.el);
					for (o = 0; (i = t.hide[o]); o++)
						(!t.toRemove.length || t.toRemove.indexOf(i) < 0) &&
							n.hide.push(i.dom.el);
					return (
						(n.id = e.id),
				...
				goMix: function (t, e) {
					...
					return (
						...
						(n.config.animation.duration &&
							n.config.animation.effects &&
							h.isVisible(n.dom.container)) ||
							(t = !1),
						e.toShow.length ||
							e.toHide.length ||
							e.willSort ||
						...
						"function" == typeof n.config.callbacks.onMixStart &&
							n.config.callbacks.onMixStart.call(
								n.dom.container,
								e.startState,
								e.newState,
								n
						...
						(i =
							n.userDeferred ||
							(n.userDeferred = h.defer(f.libraries))),
						(n.isBusy = !0),
						t && f.features.has.transitions
							? (p.pageYOffset !== e.docState.scrollTop &&
									p.scrollTo(
										e.docState.scrollLeft,
										e.docState.scrollTop
									),
							  n.config.animation.applyPerspective &&
									((n.dom.parent.style[
										f.features.perspectiveProp
									] = n.config.animation.perspectiveDistance),
									(n.dom.parent.style[
										f.features.perspectiveOriginProp
									] = n.config.animation.perspectiveOrigin)),
							  ...
							  e.startHeight === e.newHeight &&
									e.startWidth === e.newWidth &&
									(n.dom.parent.style.overflow = "hidden"),
							...
							: n.cleanUp(e),
						n.callFilters("promiseGoMix", i.promise, arguments)
					);
				},
				getStartMixData: function (t) {
					var e = this,
						n = p.getComputedStyle(e.dom.parent),
						i = e.dom.parent.getBoundingClientRect(),
						o = null,
						r = {},
						s = -1,
						a = n[f.features.boxSizingProp];
					for (
						e.incPadding = "border-box" === a,
						...
						(r = o.getPosData()),
							(t.showPosData[s] = { startPosData: r });
					for (s = 0; (o = t.toHide[s]); s++)
						(r = o.getPosData()),
							(t.toHidePosData[s] = { startPosData: r });
					(t.startX = i.left),
						(t.startY = i.top),
				...
				getInterMixData: function (t) {
					var e = null,
						n = -1;
					for (
						this.callActions("beforeGetInterMixData", arguments),
							n = 0;
						(e = t.show[n]);
						n++
					)
				...
				getFinalMixData: function (t) {
					var e,
						...
						r = -1;
					for (
						n.callActions("beforeGetFinalMixData", arguments),
							r = 0;
						(o = t.show[r]);
						r++
					)
						...
						(n.config.animation.clampHeight ||
							...
							(n.dom.parent.style.height =
								...
								n.dom.parent.style.overflow =
									""),
							n.incPadding ||
								(i = p.getComputedStyle(n.dom.parent)),
				...
				getTweenData: function (t) {
					...
					for (
						...
						for (
							(i = t.showPosData[c]).posIn = new f.StyleData(),
								i.posOut = new f.StyleData(),
								i.tweenData = new f.StyleData(),
								n.isShown
									? ((i.posIn.x =
											i.startPosData.x -
											i.interPosData.x),
								...
								e.config.animation.animateResizeTargets &&
									...
									(i.posOut.marginRight =
										i.finalPosData.marginRight - a),
									(l =
										(i.finalPosData.height ||
											i.startPosData.height) -
										i.interPosData.height),
									(i.posOut.marginBottom =
										i.finalPosData.marginBottom - l),
									(i.tweenData.width =
							...
							(s = e.effectsIn[r]) instanceof f.TransformData &&
								s.value &&
					...
					for (c = 0; (n = t.toHide[c]); c++)
						for (
							(i = t.toHidePosData[c]).posIn = new f.StyleData(),
								i.posOut = new f.StyleData(),
								i.tweenData = new f.StyleData(),
								i.posIn.x = n.isShown
								...
								i.posIn.y = n.isShown
									...
									: 0,
								i.posOut.x = e.config.animation.nudge
									? 0
									: i.posIn.x,
								i.posOut.y = e.config.animation.nudge
									? 0
									: i.posIn.y,
								i.tweenData.x = i.posOut.x - i.posIn.x,
								i.tweenData.y = i.posOut.y - i.posIn.y,
							...
							(s = e.effectsOut[r]) instanceof f.TransformData &&
								s.value &&
								((i.posIn[r].value = 0),
				...
				hasEffect: function () {
					...
					for (o = 0; (t = n[o]); o++)
						if (
							0 !==
							("undefined" !== (e = this.effectsIn[t]).value
								? e.value
								: e)
						) {
							i = !0;
				...
				checkProgress: function (t) {
					this.targetsDone++,
						this.targetsBound === this.targetsDone &&
							this.cleanUp(t);
				},
				cleanUp: function (t) {
					var e,
					...
					for (
						...
						o.cleanUp(), o.show();
					for (s = 0; (o = t.toHide[s]); s++) o.cleanUp(), o.hide();
					if (
						(t.willSort && i.printSort(!1, t),
						(i.dom.parent.style[f.features.transitionProp] =
						...
						for (s = 0; (o = i.targets[s]); s++)
							-1 < t.toRemove.indexOf(o) &&
								((e = o.dom.el.previousSibling) &&
									"#text" === e.nodeName &&
									(r = o.dom.el.nextSibling) &&
									"#text" === r.nodeName &&
									h.removeWhitespace(e),
								t.willSort ||
									i.dom.parent.removeChild(o.dom.el),
								i.targets.splice(s, 1),
								(o.isInDom = !1),
								s--);
					...
					t.willSort && (i.targets = t.newOrder),
						...
						"function" == typeof i.config.callbacks.onMixEnd &&
							i.config.callbacks.onMixEnd.call(
								i.dom.container,
								i.state,
								i
							),
						t.hasFailed &&
							...
							"function" == typeof i.config.callbacks.onMixFail &&
								i.config.callbacks.onMixFail.call(
									i.dom.container,
									i.state,
									i
								),
						...
						i.queue.length &&
							...
							(n = i.queue.shift()),
							(i.userDeferred = n.deferred),
							(i.isToggling = n.isToggling),
							(i.lastClicked = n.triggerElement),
							(n.instruction.command instanceof f.CommandMultimix
								? i.multimix
								: i.dataset
							).apply(i, n.args)),
				...
				parseMultimixArgs: function (t) {
					...
					for (
						i.animate = n.config.animation.enable,
							i.command = new f.CommandMultimix(),
							o = 0;
						o < t.length;
						o++
					)
					...
					return (
						!i.command.insert ||
							i.command.insert instanceof f.CommandInsert ||
							(i.command.insert = n.parseInsertArgs([
								i.command.insert,
							]).command),
						!i.command.remove ||
							i.command.remove instanceof f.CommandRemove ||
							(i.command.remove = n.parseRemoveArgs([
								i.command.remove,
							]).command),
						!i.command.filter ||
							i.command.filter instanceof f.CommandFilter ||
							(i.command.filter = n.parseFilterArgs([
								i.command.filter,
							]).command),
						!i.command.sort ||
							i.command.sort instanceof f.CommandSort ||
							(i.command.sort = n.parseSortArgs([
								i.command.sort,
							]).command),
						!i.command.changeLayout ||
							i.command.changeLayout instanceof
								f.CommandChangeLayout ||
							(i.command.changeLayout = n.parseChangeLayoutArgs([
								i.command.changeLayout,
							]).command),
						(i = n.callFilters(
				...
				parseFilterArgs: function (t) {
					...
					for (
						...
						"string" == typeof (e = t[i])
							...
							: "object" == typeof e &&
							  h.isElement(e, this.dom.document)
							? (n.command.collection = [e])
							: "object" == typeof e && void 0 !== e.length
							? (n.command.collection = h.arrayFromList(e))
							: "object" == typeof e
							? h.extend(n.command, e)
							: "boolean" == typeof e
							? (n.animate = e)
							: "function" == typeof e && (n.callback = e);
					if (n.command.selector && n.command.collection)
						throw new Error(
							f.messages.errorFilterInvalidArguments()
						);
					return (
						(n = this.callFilters(
				...
				parseSortArgs: function (t) {
					...
					return (
						i && (n.command = this.parseSortString(i, n.command)),
						(n = this.callFilters(
					...
					for (
						...
						null !== (e = t[i]) &&
							("number" == typeof e
								...
								? (n.animate = e)
								: "function" == typeof e && (n.callback = e));
					if (n.command.index && n.command.sibling)
						throw new Error(
							f.messages.errorInsertInvalidArguments()
						);
					return (
						!n.command.collection.length &&
							this.config.debug.showWarnings &&
				...
				parseRemoveArgs: function (t) {
					...
					for (
						...
						if (null !== (n = t[r]))
							switch (typeof n) {
								case "number":
									i.targets[n] &&
										(o.command.targets[0] = i.targets[n]);
									break;
								case "string":
									o.command.collection = h.arrayFromList(
										i.dom.parent.querySelectorAll(n)
									);
									break;
								case "object":
									n && n.length
										? (o.command.collection = n)
										: h.isElement(n, i.dom.document)
										? (o.command.collection = [n])
										: h.extend(o.command, n);
									break;
								case "boolean":
									o.animate = n;
									break;
					...
					if (o.command.collection.length)
						for (r = 0; (e = i.targets[r]); r++)
							-1 < o.command.collection.indexOf(e.dom.el) &&
								o.command.targets.push(e);
					return (
				...
				parseDatasetArgs: function (t) {
					...
					for (
						n.animate = this.config.animation.enable,
							n.command = new f.CommandDataset(),
							i = 0;
						i < t.length;
						i++
					)
				...
				parseChangeLayoutArgs: function (t) {
					...
					for (
						n.animate = this.config.animation.enable,
							n.command = new f.CommandChangeLayout(),
							i = 0;
						i < t.length;
						i++
					)
					...
					return (
						...
						n.queue.length < n.config.animation.queueLimit
							...
							: (n.config.debug.showWarnings &&
									console.warn(
										f.messages.warningMultimixInstanceQueueFull()
									),
							  i.resolve(n.state),
							  f.events.fire(
									"mixBusy",
									n.dom.container,
									{ state: n.state, instance: n },
									n.dom.document
							  ),
							  "function" ==
									typeof n.config.callbacks.onMixBusy &&
									n.config.callbacks.onMixBusy.call(
										n.dom.container,
										n.state,
										n
									)),
						n.callFilters("promiseQueueMix", i.promise, arguments)
					);
				},
				getDataOperation: function (t) {
					...
					if (
						...
						!(i = e.state.activeDataset || []).length
					)
					...
					return (
						...
						e.config.animation.enable &&
							(e.getStartMixData(n),
							e.setInter(n),
							(n.docState = h.getDocumentState(e.dom.document)),
							e.getInterMixData(n),
							e.setFinal(n),
							e.getFinalMixData(n),
							e.parseEffects(),
				...
				diffDatasets: function (t) {
					...
					for (
						...
						if (
							void 0 === (d = r[e.config.data.uidKey]) ||
							d.toString().length < 1
						)
							throw new TypeError(
						...
						if (u[d])
							throw new Error(
								f.messages.errorDatasetDuplicateUid({ uid: d })
							);
						(u[d] = !0),
							(s = e.cache[d]) instanceof f.Target
								? (e.config.data.dirtyCheck &&
										!h.deepEquals(r, s.data) &&
										((a = s.render(r)),
										(s.data = r),
										a !== s.dom.el &&
											(s.isInDom &&
												(s.unbindEvents(),
												e.dom.parent.replaceChild(
													a,
													s.dom.el
												)),
											s.isShown ||
								  ...
								  (a = s.dom.el))
								: ((s = new f.Target()).init(null, e, r),
								  s.hide()),
							s.isInDom
								? ((c = s.dom.el.nextElementSibling),
								  i.push(d),
								  l &&
										(l.lastElementChild &&
											l.appendChild(
												e.dom.document.createTextNode(
													" "
												)
											),
										e.insertDatasetFrag(l, s.dom.el, o),
										(l = null)))
								: ((l =
										l ||
										e.dom.document.createDocumentFragment())
										.lastElementChild &&
										l.appendChild(
											e.dom.document.createTextNode(" ")
										),
								  l.appendChild(s.dom.el),
								  (s.isInDom = !0),
								  s.unbindEvents(),
								  s.bindEvents(),
								  s.hide(),
					...
					for (
						l &&
							...
							e.insertDatasetFrag(l, c, o)),
							p = 0;
						(r = t.startDataset[p]);
						p++
					)
						(d = r[e.config.data.uidKey]),
							(s = e.cache[d]),
							t.show.indexOf(s) < 0
								? (t.hide.push(s),
								  t.toHide.push(s),
								  t.toRemove.push(s))
								: n.push(d);
					h.isEqualArray(n, i) || (t.willSort = !0),
					...
					return (
						...
						n.isBusy
							...
							: (i.callback && (n.userCallback = i.callback),
							  ...
							  (t = n.getDataOperation(i.command.dataset)),
							  n.goMix(e, t))
					);
				},
				multimix: function () {
					var t,
						...
						n = this,
						i = null,
						o = n.parseMultimixArgs(arguments);
					return (
						n.callActions("beforeMultimix", arguments),
						n.isBusy
							? (((i = new f.QueueItem()).args = arguments),
							  (i.instruction = o),
							  (i.triggerElement = n.lastClicked),
							  (i.isToggling = n.isToggling),
							  n.queueMix(i))
							: ((t = n.getOperation(o.command)),
							  n.config.controls.enable &&
									(o.command.filter &&
										!n.isToggling &&
										((n.toggleArray.length = 0),
										n.buildToggleArray(t.command)),
									n.queue.length < 1 &&
										n.updateControls(t.command)),
							  o.callback && (n.userCallback = o.callback),
							  (e =
				...
				getOperation: function (t) {
					...
					return (
						...
						(a.command = t),
						(a.startState = e.state),
						(a.triggerElement = e.lastClicked),
						e.isBusy
							? (e.config.debug.showWarnings &&
									console.warn(
										f.messages.warningGetOperationInstanceBusy()
									),
							  null)
							: (s && e.insertTargets(s, a),
							  r && (a.toRemove = r.targets),
							  (a.startSort = a.newSort =
									a.startState.activeSort),
							  (a.startOrder = a.newOrder = e.targets),
							  n &&
									((a.startSort = a.startState.activeSort),
									(a.newSort = n),
									(a.willSort = e.willSort(
										n,
										a.startState.activeSort
									)),
									a.willSort && e.sortOperation(a)),
							  (a.startFilter = a.startState.activeFilter),
							  (a.newFilter =
									i ||
									h.extend(
										new f.CommandFilter(),
							  ...
							  (a.startContainerClassName =
									a.startState.activeContainerClassName),
							  o
									? ((a.newContainerClassName =
											o.containerClassName),
									  a.newContainerClassName !==
											a.startContainerClassName &&
											(a.willChangeLayout = !0))
									: (a.newContainerClassName =
											a.startContainerClassName),
							  e.config.animation.enable &&
									(e.getStartMixData(a),
									e.setInter(a),
									(a.docState = h.getDocumentState(
										e.dom.document
									)),
									e.getInterMixData(a),
									e.setFinal(a),
									e.getFinalMixData(a),
									e.parseEffects(),
									(a.hasEffect = e.hasEffect()),
									e.getTweenData(a)),
							  a.willSort && (e.targets = a.newOrder),
							  (a.newState = e.buildState(a)),
							  e.callFilters(
				...
				tween: function (t, e) {
					...
					for (
						...
						(o = t.showPosData[r]), i.applyTween(o, e);
					for (r = 0; (i = t.hide[r]); r++)
						i.isShown && i.hide(),
							-1 < (n = t.toHide.indexOf(i)) &&
								((o = t.toHidePosData[n]),
								i.isShown || i.show(),
								i.applyTween(o, e));
				},
			...
			h.extend(f.Target.prototype, {
				...
				init: function (t, e, n) {
					...
					if (
						...
						if (
							void 0 === (o = n[e.config.data.uidKey]) ||
							o.toString().length < 1
						)
							throw new TypeError(
								f.messages.errorDatasetInvalidUidKey({
				...
				render: function (t) {
					...
					if (
						...
						throw new TypeError(
							f.messages.errorDatasetRendererNotSet()
						);
					return (
						(e = n(t)) && "object" == typeof e && h.isElement(e)
							? (i = e)
							: "string" == typeof e &&
					...
					for (
						...
						(i = t.tweenData[n]),
							"x" === n
								...
								: "y" === n
								? i && (a.y = r.y + i * e)
								: i instanceof f.TransformData
								? i.value &&
								  ((a[n].value = r[n].value + i.value * e),
								  (a[n].unit = i.unit),
								  s.push(n + "(" + a[n].value + i.unit + ")"))
								: i &&
								  ((a[n] = r[n] + i * e),
								  (o.dom.el.style[n] = a[n]));
					(a.x || a.y) &&
						s.unshift("translate(" + a.x + "px, " + a.y + "px)"),
						s.length &&
							(o.dom.el.style[f.features.transformProp] =
								s.join(" ")),
				...
				applyStylesIn: function (t) {
					...
					e.callActions("beforeApplyStylesIn", arguments),
						o.push("translate(" + n.x + "px, " + n.y + "px)"),
						e.mixer.config.animation.animateResizeTargets &&
							("show" !== t.statusChange &&
								((e.dom.el.style.width = n.width + "px"),
								(e.dom.el.style.height = n.height + "px")),
							(e.dom.el.style.marginRight = n.marginRight + "px"),
							(e.dom.el.style.marginBottom =
								n.marginBottom + "px")),
						i && (e.dom.el.style.opacity = n.opacity),
						"show" === t.statusChange &&
							(o = o.concat(e.mixer.transformIn)),
						(e.dom.el.style[f.features.transformProp] =
							o.join(" ")),
					...
					e.callActions("beforeHandleTransitionEnd", arguments),
						e.isBound &&
							...
							(-1 < n.indexOf("transform") ||
								-1 < n.indexOf("opacity") ||
								(i && -1 < n.indexOf("height")) ||
								(i && -1 < n.indexOf("width")) ||
								(i && -1 < n.indexOf("margin"))) &&
				...
				eventBus: function (t) {
					switch (
						(this.callActions("beforeEventBus", arguments), t.type)
					) {
				...
				getPosData: function (t) {
					...
					return (
						...
						(i.mixer.config.animation.animateResizeTargets || t) &&
							((n = i.dom.el.getBoundingClientRect()),
							(o.top = n.top),
							(o.right = n.right),
							(o.bottom = n.bottom),
							(o.left = n.left),
						...
						i.mixer.config.animation.animateResizeTargets &&
							((e = p.getComputedStyle(i.dom.el)),
							(o.marginBottom = parseFloat(e.marginBottom)),
							(o.marginRight = parseFloat(e.marginRight))),
			...
			(f.Collection = function (t) {
				var e,
					n = -1;
				for (
					this.callActions("beforeConstruct"), n = 0;
					(e = t[n]);
					n++
				)
					this[n] = e;
			...
			h.extend(f.Collection.prototype, {
				...
				mixitup: function (t) {
					var e = null,
						...
						o = -1;
					for (
						this.callActions("beforeMixitup"), n.shift(), o = 0;
						(e = this[o]);
						o++
					)
			...
			"object" == typeof exports && "object" == typeof module
				...
				: (void 0 !== p.mixitup && "function" == typeof p.mixitup) ||
				  (p.mixitup = f),
	...
	$(function () {
		...
		mixitup(".top-products__content", {
			load: { filter: ".category-all" },
		});
	});
